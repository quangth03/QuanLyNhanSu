...
<body>
    ...
    <div class="container">
        ...
        <div class="main-content">
            ...
            <%List<PhongBan> listAllPhongBan = (List<PhongBan>)request.getAttribute("listAllPhongBan");%>
            <div class="table-container">
                <table class="content-table">
                    ...
                    <tbody>
                        <% 
								for(PhongBan pb : listAllPhongBan)
								{%>
								<tr>
									<td><%=pb.getMaPB()%></td>
									<td><%=pb.getTenPB()%></td>
            ...
            <a href="Admin/adminAddDepartment.jsp"><button>Thêm Phòng Ban</button></a>
        </div>
    </div>
</body>
